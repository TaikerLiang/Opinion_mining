...
class tmhOAuth {
   ...
   */
  function request($method, $url, $params=array(), $useauth=true, $multipart=false) {              //reguest
   ...
   */
  function url($request, $format='json') {                                        //url 
